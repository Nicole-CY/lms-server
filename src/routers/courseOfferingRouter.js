...
const courseOfferingController = require('../controllers/Course/courseOfferingController');
...
router.put(
    ...
    commonValidate([
        ...
        body('teacher_id').optional().isInt().withMessage('teacher_id must be an integer'),
        ...
        body('createdBy').optional().isInt().withMessage('createdBy must be an integer'),

        body('updatedBy').optional().isInt().withMessage('updatedBy must be an integer'),
    ]),
