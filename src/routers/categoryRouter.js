 ...
 *        description: Server Error
 */
router.get('/', commonValidate(getCategoryListValidator), categoryController.getCategoryListAsync);
 ...
 *        description: Server Error
 */
router.get('/getCategoryTree', commonValidate([]), categoryController.getCategoryTreeAsync);
