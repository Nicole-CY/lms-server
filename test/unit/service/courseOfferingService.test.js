...
describe('CourseOffering Service', () => {
    ...
    describe('getCourseOfferingByIdAsync', () => {
        ...
        it('should return error if offering not found', async () => {
            ...
            expect(result).toEqual({ isSuccess: false, message: "Course offering not found", data: { id: 0 } });
        });
    });
    ...
    describe('getCourseOfferingListAsync', () => {
        it('should return paginated offerings', async () => {
            ...
            expect(pagination.getPaginatedResults).toHaveBeenCalledWith(CourseOffering, { page: 1, pageSize: 10, where: {} });
    ...
    describe('addCourseOfferingAsync', () => {
        it('should add a new course offering successfully', async () => {
            const offeringData = { courseInstanceId: 3, startDate: '2024-01-01', endDate: '2024-02-01' };
            ...
            expect(result).toEqual({ isSuccess: true, message: "Course offering added", data: { id: 1, ...offeringData } });
        });
    ...
    describe('updateCourseOfferingByIdAsync', () => {
        it('should successfully update a course offering', async () => {
            ...
            const updateData = { startDate: '2024-03-01', endDate: '2024-04-01', courseInstanceId: 101 };
    ...
    describe('deleteCourseOfferingByIdAsync', () => {
        ...
        it('should return failure when no records are deleted', async () => {
            ...
            expect(result).toEqual({ isSuccess: false, message: "No matching course offerings found" });
        });
    });
});
